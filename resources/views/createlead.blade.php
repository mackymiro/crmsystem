					 ...
					 <div class="card-body">
						<div class="form-group">
							...
							<div class="pull-right">
								<i class="fa fa-plus" aria-hidden="true"></i> <input type="submit" class="btn btn-success" value="Add Lead">
							</div>
							<br>
							<br>
							...
							<div class="form-row">
								...
								<div class="col-md-4">
									...
									<select name="leadStatus" class="form-control">
										...
										<option value="Close/Converted">Close/Converted</option>
										...
										<option value="Re-order prompt">Re-order prompt</option>
										<option value="Re-order prompt">Re-order prompt</option>
										<option value="No Number">No Number</option>
										<option value="No Contact Info">No Contact Info</option>
										<option value="Foreign Number">Foreign Number</option>
										<option value="Duplicate">Duplicate</option>
										<option value="Wrong Number">Wrong Number</option>
										<option value="Processing Tax Return">Processing Tax Return</option>
										<option value="Waiting Next Tax Year">Waiting Next Tax Year</option>
										...
										<option value="Fifth Stage">Fifth Stage</option>
									</select>
								</div>
							</div>
						</div>
