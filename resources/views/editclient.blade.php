								...
								<div class="form-row">
									...
									<div class="col-md-2">
										...
										<select name="year" class="form-control">
											<option value="1939" {{ ( 1939  == $year) ? 'selected' : '' }}>1939</option>
											<option value="1940" {{ ( 1940  == $year) ? 'selected' : '' }}>1940</option>
											<option value="1941" {{ ( 1941  == $year) ? 'selected' : '' }}>1941</option>
											<option value="1942" {{ ( 1942  == $year) ? 'selected' : '' }}>1942</option>
											<option value="1943" {{ ( 1943  == $year) ? 'selected' : '' }}>1943</option>
											<option value="1944" {{ ( 1944  == $year) ? 'selected' : '' }}>1944</option>
											<option value="1945" {{ ( 1945  == $year) ? 'selected' : '' }}>1945</option>
											<option value="1946" {{ ( 1946  == $year) ? 'selected' : '' }}>1946</option>
											<option value="1947" {{ ( 1947  == $year) ? 'selected' : '' }}>1947</option>
											<option value="1948" {{ ( 1948  == $year) ? 'selected' : '' }}>1948</option>
											<option value="1949" {{ ( 1949  == $year) ? 'selected' : '' }}>1949</option>
											<option value="1950" {{ ( 1950  == $year) ? 'selected' : '' }}>1950</option>
											<option value="1951" {{ ( 1951  == $year) ? 'selected' : '' }}>1951</option>
											<option value="1952" {{ ( 1952  == $year) ? 'selected' : '' }}>1952</option>
											<option value="1953" {{ ( 1953  == $year) ? 'selected' : '' }}>1953</option>
											<option value="1954" {{ ( 1954  == $year) ? 'selected' : '' }}>1954</option>
											<option value="1955" {{ ( 1955  == $year) ? 'selected' : '' }}>1955</option>
											<option value="1956" {{ ( 1956  == $year) ? 'selected' : '' }}>1956</option>
											<option value="1957" {{ ( 1957  == $year) ? 'selected' : '' }}>1957</option>
											<option value="1958" {{ ( 1958  == $year) ? 'selected' : '' }}>1958</option>
											<option value="1959" {{ ( 1959  == $year) ? 'selected' : '' }}>1959</option>
											<option value="1960" {{ ( 1960  == $year) ? 'selected' : '' }}>1960</option>
											<option value="1961" {{ ( 1961  == $year) ? 'selected' : '' }}>1961</option>
											<option value="1962" {{ ( 1962  == $year) ? 'selected' : '' }}>1962</option>
											<option value="1963" {{ ( 1963  == $year) ? 'selected' : '' }}>1963</option>
											<option value="1964" {{ ( 1964  == $year) ? 'selected' : '' }}>1964</option>	
											<option value="1965" {{ ( 1965  == $year) ? 'selected' : '' }}>1965</option>
											<option value="1966" {{ ( 1966  == $year) ? 'selected' : '' }}>1966</option>
											<option value="1967" {{ ( 1967  == $year) ? 'selected' : '' }}>1967</option>
											<option value="1968" {{ ( 1968  == $year) ? 'selected' : '' }}>1968</option>
											<option value="1969" {{ ( 1969  == $year) ? 'selected' : '' }}>1969</option>
