@extends('layouts.app')
@section('title', 'Create Task | RMTG')
@section('content')
<script>
							...
							<div class="form-group">
								<div class="pull-right">
									<button type="submit" class="btn btn-success">
										<i class="fa fa-tasks" aria-hidden="true"></i> Add Task
									</button>
								</div>
								<br>
								<br>
								@if(session('taskCreated'))
									<p class="alert alert-success">{{ Session::get('taskCreated') }}</p>
								@endif	
